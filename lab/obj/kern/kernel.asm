...
f01006a3:	68 78 1c 10 f0       	push   $0xf0101c78
...
f01006d6:	68 a0 1c 10 f0       	push   $0xf0101ca0
f01006db:	e8 97 02 00 00       	call   f0100977 <cprintf>
	cprintf("  entry  %08x (virt)  %08x (phys)\n", entry, entry - KERNBASE);
f01006e0:	83 c4 0c             	add    $0xc,%esp
f01006e3:	68 0c 00 10 00       	push   $0x10000c
f01006e8:	68 0c 00 10 f0       	push   $0xf010000c
f01006ed:	68 c8 1c 10 f0       	push   $0xf0101cc8
...
f010075d:	68 58 1d 10 f0       	push   $0xf0101d58
f0100762:	e8 10 02 00 00       	call   f0100977 <cprintf>
		ROUNDUP(end - entry, 1024) / 1024);
	return 0;
}
...
f0100778:	68 0e 1c 10 f0       	push   $0xf0101c0e
f010077d:	e8 f5 01 00 00       	call   f0100977 <cprintf>
	while(ebp != 0){
...
f010079d:	68 84 1d 10 f0       	push   $0xf0101d84
f01007a2:	e8 d0 01 00 00       	call   f0100977 <cprintf>
				*((uintptr_t *)ebp + 1), *((uintptr_t *)ebp + 2), *((uintptr_t *)ebp + 3), 
			    *((uintptr_t *)ebp + 4), *((uintptr_t *)ebp + 5), *((uintptr_t *)ebp + 6));
		debuginfo_eip(*((uintptr_t *)ebp + 1), &info);
...
f01007ae:	e8 ce 02 00 00       	call   f0100a81 <debuginfo_eip>
...
f01007c9:	68 20 1c 10 f0       	push   $0xf0101c20
f01007ce:	e8 a4 01 00 00       	call   f0100977 <cprintf>
...
f01007f1:	68 bc 1d 10 f0       	push   $0xf0101dbc
f01007f6:	e8 7c 01 00 00       	call   f0100977 <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f01007fb:	c7 04 24 e0 1d 10 f0 	movl   $0xf0101de0,(%esp)
f0100802:	e8 70 01 00 00       	call   f0100977 <cprintf>

	cprintf("x=%d y=%d", 3);
f0100807:	83 c4 08             	add    $0x8,%esp
f010080a:	6a 03                	push   $0x3
f010080c:	68 30 1c 10 f0       	push   $0xf0101c30
f0100811:	e8 61 01 00 00       	call   f0100977 <cprintf>
f0100816:	83 c4 10             	add    $0x10,%esp
	
	while (1) {
		buf = readline("K> ");
f0100819:	83 ec 0c             	sub    $0xc,%esp
f010081c:	68 3a 1c 10 f0       	push   $0xf0101c3a
f0100821:	e8 b3 09 00 00       	call   f01011d9 <readline>
f0100826:	89 c3                	mov    %eax,%ebx
		if (buf != NULL)
f0100828:	83 c4 10             	add    $0x10,%esp
f010082b:	85 c0                	test   %eax,%eax
f010082d:	74 ea                	je     f0100819 <monitor+0x31>
	char *argv[MAXARGS];
	int i;
...
f010083b:	eb 0a                	jmp    f0100847 <monitor+0x5f>
	argv[argc] = 0;
	while (1) {
		// gobble whitespace
...
f010084c:	74 63                	je     f01008b1 <monitor+0xc9>
f010084e:	83 ec 08             	sub    $0x8,%esp
f0100851:	0f be c0             	movsbl %al,%eax
f0100854:	50                   	push   %eax
f0100855:	68 3e 1c 10 f0       	push   $0xf0101c3e
f010085a:	e8 94 0b 00 00       	call   f01013f3 <strchr>
f010085f:	83 c4 10             	add    $0x10,%esp
f0100862:	85 c0                	test   %eax,%eax
f0100864:	75 d7                	jne    f010083d <monitor+0x55>
			*buf++ = 0;
		if (*buf == 0)
f0100866:	80 3b 00             	cmpb   $0x0,(%ebx)
f0100869:	74 46                	je     f01008b1 <monitor+0xc9>
			break;

		// save and scan past next arg
		if (argc == MAXARGS-1) {
f010086b:	83 fe 0f             	cmp    $0xf,%esi
f010086e:	75 14                	jne    f0100884 <monitor+0x9c>
			cprintf("Too many arguments (max %d)\n", MAXARGS);
f0100870:	83 ec 08             	sub    $0x8,%esp
f0100873:	6a 10                	push   $0x10
f0100875:	68 43 1c 10 f0       	push   $0xf0101c43
f010087a:	e8 f8 00 00 00       	call   f0100977 <cprintf>
f010087f:	83 c4 10             	add    $0x10,%esp
f0100882:	eb 95                	jmp    f0100819 <monitor+0x31>
			return 0;
		}
		argv[argc++] = buf;
f0100884:	8d 7e 01             	lea    0x1(%esi),%edi
f0100887:	89 5c b5 a8          	mov    %ebx,-0x58(%ebp,%esi,4)
f010088b:	eb 03                	jmp    f0100890 <monitor+0xa8>
		while (*buf && !strchr(WHITESPACE, *buf))
			buf++;
...
f0100895:	74 ae                	je     f0100845 <monitor+0x5d>
f0100897:	83 ec 08             	sub    $0x8,%esp
f010089a:	0f be c0             	movsbl %al,%eax
f010089d:	50                   	push   %eax
f010089e:	68 3e 1c 10 f0       	push   $0xf0101c3e
f01008a3:	e8 4b 0b 00 00       	call   f01013f3 <strchr>
f01008a8:	83 c4 10             	add    $0x10,%esp
f01008ab:	85 c0                	test   %eax,%eax
f01008ad:	74 de                	je     f010088d <monitor+0xa5>
f01008af:	eb 94                	jmp    f0100845 <monitor+0x5d>
			buf++;
	}
	argv[argc] = 0;
...
f01008bb:	0f 84 58 ff ff ff    	je     f0100819 <monitor+0x31>
		return 0;
	for (i = 0; i < ARRAY_SIZE(commands); i++) {
		if (strcmp(argv[0], commands[i].name) == 0)
f01008c1:	83 ec 08             	sub    $0x8,%esp
f01008c4:	68 de 1b 10 f0       	push   $0xf0101bde
f01008c9:	ff 75 a8             	pushl  -0x58(%ebp)
f01008cc:	e8 c4 0a 00 00       	call   f0101395 <strcmp>
f01008d1:	83 c4 10             	add    $0x10,%esp
f01008d4:	85 c0                	test   %eax,%eax
f01008d6:	74 1e                	je     f01008f6 <monitor+0x10e>
f01008d8:	83 ec 08             	sub    $0x8,%esp
f01008db:	68 ec 1b 10 f0       	push   $0xf0101bec
f01008e0:	ff 75 a8             	pushl  -0x58(%ebp)
f01008e3:	e8 ad 0a 00 00       	call   f0101395 <strcmp>
f01008e8:	83 c4 10             	add    $0x10,%esp
f01008eb:	85 c0                	test   %eax,%eax
f01008ed:	75 2f                	jne    f010091e <monitor+0x136>
	argv[argc] = 0;
	...
	if (argc == 0)
		return 0;
	for (i = 0; i < ARRAY_SIZE(commands); i++) {
f01008ef:	b8 01 00 00 00       	mov    $0x1,%eax
f01008f4:	eb 05                	jmp    f01008fb <monitor+0x113>
		if (strcmp(argv[0], commands[i].name) == 0)
f01008f6:	b8 00 00 00 00       	mov    $0x0,%eax
			return commands[i].func(argc, argv, tf);
f01008fb:	83 ec 04             	sub    $0x4,%esp
f01008fe:	8d 14 00             	lea    (%eax,%eax,1),%edx
f0100901:	01 d0                	add    %edx,%eax
f0100903:	ff 75 08             	pushl  0x8(%ebp)
f0100906:	8d 4d a8             	lea    -0x58(%ebp),%ecx
f0100909:	51                   	push   %ecx
f010090a:	56                   	push   %esi
f010090b:	ff 14 85 10 1e 10 f0 	call   *-0xfefe1f0(,%eax,4)
	cprintf("x=%d y=%d", 3);
...
f0100917:	78 1d                	js     f0100936 <monitor+0x14e>
f0100919:	e9 fb fe ff ff       	jmp    f0100819 <monitor+0x31>
		return 0;
	for (i = 0; i < ARRAY_SIZE(commands); i++) {
		if (strcmp(argv[0], commands[i].name) == 0)
			return commands[i].func(argc, argv, tf);
...
f0100924:	68 60 1c 10 f0       	push   $0xf0101c60
f0100929:	e8 49 00 00 00       	call   f0100977 <cprintf>
f010092e:	83 c4 10             	add    $0x10,%esp
f0100931:	e9 e3 fe ff ff       	jmp    f0100819 <monitor+0x31>
		buf = readline("K> ");
		if (buf != NULL)
			if (runcmd(buf, tf) < 0)
				break;
...
f0100a90:	c7 03 20 1e 10 f0    	movl   $0xf0101e20,(%ebx)
	info->eip_line = 0;
f0100a96:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	info->eip_fn_name = "<unknown>";
f0100a9d:	c7 43 08 20 1e 10 f0 	movl   $0xf0101e20,0x8(%ebx)
...
f0100abd:	b8 00 73 10 f0       	mov    $0xf0107300,%eax
f0100ac2:	3d e9 59 10 f0       	cmp    $0xf01059e9,%eax
...
f0100ad1:	68 2a 1e 10 f0       	push   $0xf0101e2a
f0100ad6:	6a 7f                	push   $0x7f
f0100ad8:	68 37 1e 10 f0       	push   $0xf0101e37
f0100add:	e8 04 f6 ff ff       	call   f01000e6 <_panic>
	}

	// String table validity checks
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
f0100ae2:	80 3d ff 72 10 f0 00 	cmpb   $0x0,0xf01072ff
...
f0100af6:	b8 e8 59 10 f0       	mov    $0xf01059e8,%eax
f0100afb:	2d 58 20 10 f0       	sub    $0xf0102058,%eax
...
f0100b1b:	b8 58 20 10 f0       	mov    $0xf0102058,%eax
...
f0100b48:	b8 58 20 10 f0       	mov    $0xf0102058,%eax
...
f0100b65:	8d b9 58 20 10 f0    	lea    -0xfefdfa8(%ecx),%edi
f0100b6b:	89 7d c4             	mov    %edi,-0x3c(%ebp)
f0100b6e:	8b b9 58 20 10 f0    	mov    -0xfefdfa8(%ecx),%edi
f0100b74:	b9 00 73 10 f0       	mov    $0xf0107300,%ecx
f0100b79:	81 e9 e9 59 10 f0    	sub    $0xf01059e9,%ecx
f0100b7f:	39 cf                	cmp    %ecx,%edi
f0100b81:	73 09                	jae    f0100b8c <debuginfo_eip+0x10b>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f0100b83:	81 c7 e9 59 10 f0    	add    $0xf01059e9,%edi
...
f0100bcd:	b8 58 20 10 f0       	mov    $0xf0102058,%eax
...
f0100be9:	8d 04 85 58 20 10 f0 	lea    -0xfefdfa8(,%eax,4),%eax
...
f0100c1d:	8b 14 85 58 20 10 f0 	mov    -0xfefdfa8(,%eax,4),%edx
f0100c24:	b8 00 73 10 f0       	mov    $0xf0107300,%eax
f0100c29:	2d e9 59 10 f0       	sub    $0xf01059e9,%eax
f0100c2e:	39 c2                	cmp    %eax,%edx
f0100c30:	73 08                	jae    f0100c3a <debuginfo_eip+0x1b9>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0100c32:	81 c2 e9 59 10 f0    	add    $0xf01059e9,%edx
...
f0100c51:	8d 14 95 58 20 10 f0 	lea    -0xfefdfa8(,%edx,4),%edx
...
f0100d3b:	0f be 80 45 1e 10 f0 	movsbl -0xfefe1bb(%eax),%eax
...
f0100e37:	ff 24 85 d4 1e 10 f0 	jmp    *-0xfefe12c(,%eax,4)
...
f0100f1f:	68 66 1e 10 f0       	push   $0xf0101e66
...
f0100f43:	b8 56 1e 10 f0       	mov    $0xf0101e56,%eax
...
f01011ed:	68 66 1e 10 f0       	push   $0xf0101e66
...
f010121d:	68 48 20 10 f0       	push   $0xf0102048
